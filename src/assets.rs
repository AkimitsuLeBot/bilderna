...
lazy_static! {
    ...
    pub static ref KNIGHT_ICON : RgbaImage = load_from_memory(include_bytes!("../assets/knight.png"))
        .expect("Failed to load map")
        .to_rgba8();

    pub static ref TRAVELER_ICON : RgbaImage = load_from_memory(include_bytes!("../assets/traveler.png"))
        .expect("Failed to load map")
        .to_rgba8();

    pub static ref WIZARD_ICON : RgbaImage = load_from_memory(include_bytes!("../assets/wizard.png"))
        .expect("Failed to load map")
        .to_rgba8();
